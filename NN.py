...
# y: actual output array for the input cluster
...
# datasets: tuple of training and output datasets
...
def predict(w, b, layers, centroids, cluster):
	# print(cluster)
	...
	for i in range(1, row - 1):
		...
		for j in range(1, col - 1):
			if j < int(col / 2):
				...
				color = predict(w, b, layers, centroids, cluster)
